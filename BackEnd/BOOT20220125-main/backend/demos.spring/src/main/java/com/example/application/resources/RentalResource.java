...
public class RentalResource {
	...
	@GetMapping(path = "/{id}")
	public RentalDTOdetalles getOneDetails(@PathVariable int id, @RequestParam(required = false, defaultValue = "details") String mode)
	...
	public void update(@ApiParam(value = "Identificador del alquiler") @PathVariable int id, @Valid @RequestBody RentalDTOeditar item)
